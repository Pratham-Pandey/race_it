...
class CmdVelPublisher(Node):
    ...
    def timer_callback(self):
        ...
        print("2_TYPE: ", type(twist))
        print("3_TYPE: ", type(twist_msg))
...
class race_it_agent(gym.Env):
    ...
    def _get_obs(self):
        ...
        # Filtering contour on the basis of area.
        contours = [contour for contour in contours if cv2.contourArea(contour) >= self.min_cont_area]
        ...
        road_edge = {"right": None, "left": None}
